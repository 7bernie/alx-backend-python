...
[0x03. Unittests and Integration Tests](https://intranet.alxswe.com/projects/1237)
...
Use unittest.mock.patch to mock a_method. Test that when calling a_property twice, 
the correct result is returned but a_method is only called once using assert_called_once.
